 ...
 * @version 2017
 */
public class DrawComplexMultiplication extends Application {
    ...
    public void processMouseClick(MouseEvent event) {
        ...
        if (z1 == null) {
            ...
            l1 = drawZ(z1, Color.CYAN);
        } else {
            z2 = new Complex(coordRe(x), coordIm(y));
            l2 = drawZ(z2, Color.CYAN);
            product = drawZ(z1.multiply(z2), Color.LIGHTGREEN);
        }
    }
    ...
    private Line drawZ(Complex z, Color c) {
